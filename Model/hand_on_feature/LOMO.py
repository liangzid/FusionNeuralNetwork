...
def LOMO(imgs,num_of_img=2,c_list=[5,20],low_clip=0.1,high_clip=0.9,
         R_list=[3,5],tau=0.3,hsv_bin_size=8,blocksize=32,block_step=16):

    feature=np.zeros((num_of_img,70770))

    for i in range(num_of_img):
        feature[i,:]=LOMO_per(imgs[i,:,:,:],c_list,low_clip,high_clip,R_list,
                            tau,hsv_bin_size,blocksize,block_step)
